 ...
 *
 * The followings are the available columns in table 'book_genre':
 * @property integer $id
...
class BookGenre extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('bid, gid', 'required'),
			array('bid, gid', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, bid, gid', 'safe', 'on'=>'search'),
		);
	}
